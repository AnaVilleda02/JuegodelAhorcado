...
;(function(){
    ...
    const btnMatar=document.querySelector("#btnMatar");
    ...
    var terminado=false;
    var valores_html={
        hombre:document.getElementById("mon_ahorcado"),
    ...
    function dibujar_ahorcado(juego){
        ...
        elemento.src="imag/Ahorcado" + estado + ".png";
...
//    nuevoJuego();
    ...
    btnMatar.onclick=eliminaPalabraPrincipal;
